...
def apri_finestra_istruzioni():
    ...
    output_message.insert(tk.END, "\n2) Selezionare la cartella e il nome del file di output compresso.\n")
...
if __name__ == '__main__':
    ...
    ########COSTRUZIONE DELLA FINESTRA PRINCIPALE
    ...
    file_menu.add_command(label="Apri cbr/cbz", command=select_input_file)
    file_menu.add_command(label="Esporta cbz", command=select_output_file)
